...
<title>Dunder Mifflin — Dashboard</title>
<link rel="stylesheet" href="../css/style.css">
</head><body>
<div class="layout">
<?php require_once '../includes/sidebar.php'; ?>
<div class="contenido">
  <div class="topbar"><h1>Dashboard</h1><div class="topbar-right text-gris"><?=date('d/m/Y — H:i')?></div></div>
  <main class="main">
    <div class="stats-grid">
      ...
      <div class="stat-card <?=$pedidos_activos>0?'naranja':''?>"><div class="stat-label">Pedidos en curso</div><div class="stat-valor"><?=$pedidos_activos?></div></div>
    </div>
