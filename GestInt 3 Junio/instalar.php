...
$tablas = [
"usuarios" => "CREATE TABLE IF NOT EXISTS usuarios (id INT UNSIGNED AUTO_INCREMENT PRIMARY KEY, nombre VARCHAR(80) NOT NULL, apellidos VARCHAR(100) NOT NULL DEFAULT '', usuario VARCHAR(50) NOT NULL UNIQUE, email VARCHAR(120) NOT NULL, password VARCHAR(255) NOT NULL, rol ENUM('admin','rrhh','almacen','empleado') NOT NULL DEFAULT 'empleado', activo TINYINT(1) NOT NULL DEFAULT 1, created_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP) ENGINE=InnoDB",
...
"inventario" => "CREATE TABLE IF NOT EXISTS inventario (id INT UNSIGNED AUTO_INCREMENT PRIMARY KEY, nombre VARCHAR(150) NOT NULL, categoria VARCHAR(60) NOT NULL DEFAULT 'Otros', descripcion TEXT DEFAULT NULL, cantidad INT NOT NULL DEFAULT 0, stock_minimo INT NOT NULL DEFAULT 5, unidad VARCHAR(30) NOT NULL DEFAULT 'unidad', proveedor VARCHAR(100) DEFAULT NULL, precio_unitario DECIMAL(10,2) NOT NULL DEFAULT 0.00, fecha_entrada DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP) ENGINE=InnoDB",
...
$datos = [
    ['Michael','Scott','michael','michael.scott@dundermifflin.com','Michael1234','admin',['12345678Z','michael.scott@dundermifflin.com','570100001','Dirección','Regional Manager','2005-03-24',65000]],
    ['Dwight','Schrute','dwight','dwight.schrute@dundermifflin.com','Dwight1234','almacen',['23456789D','dwight.schrute@dundermifflin.com','570100002','Ventas','Assistant to the RM','2005-03-24',42000]],
    ['Jim','Halpert','jim','jim.halpert@dundermifflin.com','Jim1234!!','empleado',['34567890V','jim.halpert@dundermifflin.com','570100003','Ventas','Sales Representative','2005-03-24',40000]],
    ['Pam','Beesly','pam','pam.beesly@dundermifflin.com','Pam1234!!','rrhh',['45678901G','pam.beesly@dundermifflin.com','570100004','Recepción','Receptionist','2005-03-24',32000]],
    ['Toby','Flenderson','toby','toby.flenderson@dundermifflin.com','Toby1234!','rrhh',['56789012B','toby.flenderson@dundermifflin.com','570100005','RRHH','HR Representative','2005-03-24',38000]],
    ['Angela','Martin','angela','angela.martin@dundermifflin.com','Angela1234','empleado',['67890123B','angela.martin@dundermifflin.com','570100006','Contabilidad','Head of Accounting','2005-03-24',41000]],
    ['Oscar','Martinez','oscar','oscar.martinez@dundermifflin.com','Oscar1234!','empleado',['78901234X','oscar.martinez@dundermifflin.com','570100007','Contabilidad','Accountant','2005-03-24',39000]],
    ['Kevin','Malone','kevin','kevin.malone@dundermifflin.com','Kevin1234!','empleado',['89012345E','kevin.malone@dundermifflin.com','570100008','Contabilidad','Accountant','2005-03-24',36000]],
    ['Stanley','Hudson','stanley','stanley.hudson@dundermifflin.com','Stanley1234','empleado',['90123456A','stanley.hudson@dundermifflin.com','570100009','Ventas','Sales Representative','2005-03-24',40000]],
    ['Phyllis','Vance','phyllis','phyllis.vance@dundermifflin.com','Phyllis1234','empleado',['12345679S','phyllis.vance@dundermifflin.com','570100010','Ventas','Sales Representative','2005-03-24',39000]],
    ['Andy','Bernard','andy','andy.bernard@dundermifflin.com','Andy1234!!','empleado',['11223344B','andy.bernard@dundermifflin.com','570100011','Ventas','Sales Representative','2007-01-15',39000]],
    ['Darryl','Philbin','darryl','darryl.philbin@dundermifflin.com','Darryl1234','almacen',['22334455Y','darryl.philbin@dundermifflin.com','570100012','Almacén','Warehouse Foreman','2005-03-24',37000]],
    ['Roy','Anderson','roy','roy.anderson@dundermifflin.com','Roy12345!','almacen',['33445566R','roy.anderson@dundermifflin.com','570100013','Almacén','Warehouse Worker','2005-03-24',32000]],
];
...
// todos los usuarios tienen SELECT en todas las tablas
// escritura restringida por rol
$tablas_todas = ['usuarios','empleados','inventario','pedidos','pedidos_lineas','logs_acceso'];
$usuarios_mysql = [
    'login_gestint'    => ['Login2024!',    ['INSERT ON gestint.logs_acceso']],
    'admin_gestint'    => ['Admin2024!',    ['ALL PRIVILEGES ON gestint.*']],
    'rrhh_gestint'     => ['RRHH2024!',     ['INSERT, UPDATE, DELETE ON gestint.empleados','INSERT, UPDATE, DELETE ON gestint.usuarios']],
    'almacen_gestint'  => ['Almacen2024!',  ['INSERT, UPDATE, DELETE ON gestint.inventario','INSERT, UPDATE, DELETE ON gestint.pedidos','INSERT, UPDATE, DELETE ON gestint.pedidos_lineas']],
    'empleado_gestint' => ['Empleado2024!', ['UPDATE (password) ON gestint.usuarios']],
];
