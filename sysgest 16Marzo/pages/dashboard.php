...
$ultimos_emp = $conn->query(
    "SELECT nombre, apellidos, departamento, fecha_alta FROM empleados
     ORDER BY fecha_alta DESC LIMIT 5"
);

// Artículos con stock bajo
$stock_alerta = $conn->query(
    "SELECT nombre, categoria, cantidad, stock_minimo FROM inventario
        ...
        <main class="main">
            ...
            <div class="stats-grid">
                ...
                <div class="stat-card naranja">
                    ...
                    <div class="stat-valor"><?= $total_usuarios ?></div>
                </div>
            </div>
            ...
            <div style="display:grid;grid-template-columns:1fr 1fr;gap:20px;flex-wrap:wrap;">
                ...
                <div class="panel">
                    <div class="panel-header">
                        <h2>⚠️ Artículos con stock bajo</h2>
                    ...
                    <table>
                        ...
                        <?php if ($stock_alerta && $stock_alerta->num_rows > 0): ?>
                            ...
                            <?php endwhile; ?>
                        <?php else: ?>
                            <tr><td colspan="3" class="text-gris text-center">Todo el stock en orden ✓</td></tr>
                        <?php endif; ?>
                        </tbody>
                    </table>
                </div>
