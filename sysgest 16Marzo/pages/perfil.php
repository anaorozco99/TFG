...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($nueva !== $repetir) $errores[] = 'Las contraseñas nuevas no coinciden.';
            ...
            <div style="display:grid;grid-template-columns:1fr 1fr;gap:20px;">
                ...
                <div class="panel">
                    ...
                    <div class="panel-body">
                        <table>
                            <tr><td class="text-gris" style="padding:8px 0;width:140px;">Nombre</td>
                                <td class="fw-600"><?= htmlspecialchars($usuario['nombre'] . ' ' . $usuario['apellidos']) ?></td></tr>
                            <tr><td class="text-gris" style="padding:8px 0;">Usuario</td>
                                <td><?= htmlspecialchars($usuario['usuario']) ?></td></tr>
                            <tr><td class="text-gris" style="padding:8px 0;">Email</td>
                                <td><?= htmlspecialchars($usuario['email']) ?></td></tr>
                            <tr><td class="text-gris" style="padding:8px 0;">Rol</td>
                                <td><span class="badge badge-azul"><?= nombreRol($usuario['rol']) ?></span></td></tr>
                        </table>
                    </div>
                </div>
