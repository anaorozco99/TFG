...
$borrar = ['pedidos_ventas_lineas','pedidos_ventas','pedidos_lineas','pedidos',
           'logs_acceso','fichajes','justificantes','clientes','empleados','inventario','usuarios'];
foreach ($borrar as $t) {
...
$tablas = [
"usuarios" => "CREATE TABLE IF NOT EXISTS usuarios (id INT UNSIGNED AUTO_INCREMENT PRIMARY KEY, nombre VARCHAR(80) NOT NULL, apellidos VARCHAR(100) NOT NULL DEFAULT '', usuario VARCHAR(50) NOT NULL UNIQUE, email VARCHAR(120) NOT NULL, password VARCHAR(255) NOT NULL, rol ENUM('admin','rrhh','almacen','empleado','soporte') NOT NULL DEFAULT 'empleado', activo TINYINT(1) NOT NULL DEFAULT 1, created_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP) ENGINE=InnoDB",
...
$datos = [
    ['Michael','Scott',  'admin',  'michael.scott@dundermifflin.com', 'Michael1234','admin',  ['12345678Z','michael.scott@dundermifflin.com', '570100001','Dirección',   'Director Regional',         '2005-03-24',65000]],
...
$tablas_todas = ['usuarios','empleados','inventario','pedidos','pedidos_lineas','logs_acceso','clientes','pedidos_ventas','pedidos_ventas_lineas','fichajes','justificantes'];
$usuarios_mysql = [
