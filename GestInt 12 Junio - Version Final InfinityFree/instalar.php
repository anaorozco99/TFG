<?php
$conn = new mysqli('sql211.infinityfree.com', 'if0_42132698', 'jkkrejLaCivXtV', 'if0_42132698_gestint');
...
// InfinityFree: un solo usuario MySQL por base de datos (plan gratuito)
// La creación de usuarios MySQL por rol no está disponible
$ok[] = "InfinityFree: conexión única — usuarios MySQL por rol omitidos";
?>
