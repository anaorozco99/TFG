...
<head>
    ...
    <title>Dunder Mifflin — Pedidos</title>
        ...
        <main class="main">
            ...
            <div class="panel">
                <table>
                    ...
                    <?php else: ?>
                        <tr>
                            <td colspan="7" class="text-gris text-center" style="padding:28px;">No hay pedidos.</td>
                        </tr>
                    <?php endif; ?>
                    </tbody>
                </table>
...
<div class="modal-overlay" id="det<?= $p['id'] ?>">
    <div class="modal">
        ...
        <div class="modal-body">
            <?php
            $stmtL = $conn->prepare("SELECT nombre, cantidad FROM pedidos_lineas WHERE pedido_id = ?");
