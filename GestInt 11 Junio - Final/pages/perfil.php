...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($accion === 'contra') {
        ...
        if (!preg_match('/^(?=.*[A-Z])(?=.*[a-z])(?=.*\d)(?=.*[^A-Za-z0-9]).{6,}$/', $nueva))
            $errores[] = 'La nueva contraseña debe tener mínimo 6 caracteres, mayúscula, minúscula, número y carácter especial.';
      ...
      <div class="panel">
        ...
        <div class="panel-body">
          <form method="POST" class="form-grid">
            ...
            <div class="form-grupo full"><label>Nueva contraseña</label><input type="password" name="contra_nueva" required minlength="6" placeholder="Mín. 6 chars, mayús, minús, número y especial"></div>
      ...
      <div class="panel-body">
        ...
        <table>
          ...
          <tr>
            ...
            <td><a href="descargar_justificante.php?f=<?= urlencode($j['archivo']) ?>" target="_blank" class="btn btn-gris btn-sm">📄 Ver</a></td>
