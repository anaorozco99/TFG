...
$borrar = ['pedidos_ventas_lineas','pedidos_ventas','pedidos_lineas','pedidos',
           'logs_acceso','logs_actividad','fichajes','justificantes','tickets','vacaciones','clientes','empleados','inventario','usuarios'];
foreach ($borrar as $t) {
...
$tablas = [
"usuarios" => "CREATE TABLE IF NOT EXISTS usuarios (id INT UNSIGNED AUTO_INCREMENT PRIMARY KEY, nombre VARCHAR(80) NOT NULL, apellidos VARCHAR(100) NOT NULL DEFAULT '', usuario VARCHAR(50) NOT NULL UNIQUE, email VARCHAR(120) NOT NULL, password VARCHAR(255) NOT NULL, rol ENUM('sistema','it','direccion','rrhh','almacen','ventas','contabilidad','recepcion') NOT NULL DEFAULT 'ventas', activo TINYINT(1) NOT NULL DEFAULT 1, created_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP) ENGINE=InnoDB",
...
"logs_actividad" => "CREATE TABLE IF NOT EXISTS logs_actividad (id INT UNSIGNED AUTO_INCREMENT PRIMARY KEY, usuario_id INT UNSIGNED NOT NULL, usuario_nombre VARCHAR(100) NOT NULL, rol VARCHAR(20) NOT NULL, accion VARCHAR(50) NOT NULL, tabla VARCHAR(50) NOT NULL, registro_id INT UNSIGNED DEFAULT NULL, detalle VARCHAR(300) DEFAULT NULL, fecha DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP, CONSTRAINT fk_lact_usr FOREIGN KEY (usuario_id) REFERENCES usuarios(id)) ENGINE=InnoDB",
...
$datos = [
    ['Michael','Scott',  'michael','michael.scott@dundermifflin.com', 'Michael1234','direccion',  ['12345678Z','michael.scott@dundermifflin.com', '970100001','Dirección',   'Director Regional',         '2005-03-24',65000]],
    ['Dwight', 'Schrute','dwight', 'dwight.schrute@dundermifflin.com','Dwight1234', 'ventas',     ['23456789D','dwight.schrute@dundermifflin.com','970100002','Ventas',      'Asistente del Director',    '2005-03-24',42000]],
    ['Jim',    'Halpert','jim',    'jim.halpert@dundermifflin.com',    'Jim1234!!',  'ventas',     ['34567890V','jim.halpert@dundermifflin.com',   '970100003','Ventas',      'Comercial',                 '2005-03-24',40000]],
    ['Pam',    'Beesly', 'pam',   'pam.beesly@dundermifflin.com',     'Pam1234!!',  'recepcion',  ['45678901G','pam.beesly@dundermifflin.com',    '970100004','Recepción',   'Recepcionista',             '2005-03-24',32000]],
    ['Toby',   'Flenderson','toby','toby.flenderson@dundermifflin.com','Toby1234!',  'rrhh',       ['56789012B','toby.flenderson@dundermifflin.com','970100005','RRHH',        'Técnico de RRHH',           '2005-03-24',38000]],
    ['Angela', 'Martin', 'angela','angela.martin@dundermifflin.com',   'Angela1234', 'contabilidad',['67890123B','angela.martin@dundermifflin.com', '970100006','Contabilidad','Jefa de Contabilidad',      '2005-03-24',41000]],
    ['Oscar',  'Martinez','oscar','oscar.martinez@dundermifflin.com',  'Oscar1234!', 'contabilidad',['78901234X','oscar.martinez@dundermifflin.com','970100007','Contabilidad','Contable',                  '2005-03-24',39000]],
    ['Kevin',  'Malone', 'kevin', 'kevin.malone@dundermifflin.com',    'Kevin1234!', 'contabilidad',['89012345E','kevin.malone@dundermifflin.com',  '970100008','Contabilidad','Contable',                  '2005-03-24',36000]],
    ['Stanley','Hudson', 'stanley','stanley.hudson@dundermifflin.com', 'Stanley1234','ventas',     ['90123456A','stanley.hudson@dundermifflin.com','970100009','Ventas',      'Comercial',                 '2005-03-24',40000]],
    ['Phyllis','Vance',  'phyllis','phyllis.vance@dundermifflin.com',  'Phyllis1234','ventas',     ['12345679S','phyllis.vance@dundermifflin.com', '970100010','Ventas',      'Comercial',                 '2005-03-24',39000]],
    ['Andy',   'Bernard','andy',  'andy.bernard@dundermifflin.com',    'Andy1234!!', 'ventas',     ['11223344B','andy.bernard@dundermifflin.com',  '970100011','Ventas',      'Comercial',                 '2007-01-15',39000]],
    ['Darryl', 'Philbin','darryl','darryl.philbin@dundermifflin.com',  'Darryl1234', 'almacen',    ['22334455Y','darryl.philbin@dundermifflin.com','970100012','Almacén',     'Jefe de Almacén',           '2005-03-24',37000]],
    ['Roy',    'Anderson','roy',  'roy.anderson@dundermifflin.com',    'Roy12345!',  'almacen',    ['33445566R','roy.anderson@dundermifflin.com',  '970100013','Almacén',     'Auxiliar de Almacén',       '2005-03-24',32000]],
    ['Ryan',   'Howard', 'ryan',  'ryan.howard@dundermifflin.com',     'Ryan1234!',  'ventas',     ['44556677L','ryan.howard@dundermifflin.com',   '970100014','Ventas',      'Comercial',                 '2007-01-15',38000]],
    ['Ana',    'Orozco Asensio','ana','anaorozcoasensio@gmail.com',    'Ana1234!',   'it',         ['98765432M','anaorozcoasensio@gmail.com',       '970100015','IT',          'Técnico de Soporte IT',     '2024-09-01',30000]],
    ['Alberto','Sánchez',      'alberto','alberto.sanchez@dundermifflin.com','Alberto1234!','it',  ['87654321X','alberto.sanchez@dundermifflin.com','970100016','IT','Técnico de Soporte IT','2023-06-01',31000]],
];
...
// usuario sistema: acceso total, contraseña propia, no aparece en listas normales
$hash_sis = password_hash('Sistema2026*', PASSWORD_DEFAULT);
$s_sis = $conn->prepare("INSERT IGNORE INTO usuarios (nombre,apellidos,usuario,email,password,rol) VALUES ('Sistema','','sistema','sistema@dundermifflin.com',?,'sistema')");
$s_sis->bind_param('s', $hash_sis);
$s_sis->execute();
$ok[] = "Usuario <b>sistema</b> creado (rol sistema, contraseña Sistema2026*)";
...
$clientes_seed = [
    ['Vance Refrigeration', 'Vance Refrigeration Corp.',  'bob.vance@vancerefrigeration.com','970200001','Calle Industrial 1', 'Scranton'],
    ['Prince Family Paper', 'Prince Family Paper Co.',    'info@princepaper.com',            '970200002','Av. Principal 45',   'Carbondale'],
    ['Lackawanna County',   'Condado de Lackawanna',      'compras@lackawanna.gov',          '970200003','Calle Gobierno 100', 'Scranton'],
    ['Dunmore High School', 'Instituto Dunmore',          'pedidos@dunmore.edu',             '970200004','Calle Escolar 50',   'Dunmore'],
];
...
// ---- Todos los pedidos de stock (2025+2026, orden cronológico para IDs secuenciales) ----
$todos_stock = [
    // ── 2025 ──
    ['darryl','recibido','2025-01-20 08:30:00','Pedido inicio año',[
        ['Papel A4 80g (500 hojas)',40],['Tóner HP LaserJet negro',2],
    ]],
    ['roy',  'recibido','2025-02-17 09:00:00','Consumibles febrero',[
        ['Post-it 76x76 (pack 12)',6],['Celo 19mm x 33m (pack 10)',4],['Grapas 26/6 (caja 5000)',3],
    ]],
    ['darryl','recibido','2025-04-07 10:00:00','Reposición Q2',[
        ['Papel A4 80g (500 hojas)',30],['Papel reciclado A4 (500h)',10],['Sobres blancos C4 (caja 250)',4],
    ]],
    ['darryl','recibido','2025-06-09 08:00:00','Material verano',[
        ['Bolígrafos azul BIC (caja)',8],['Bolígrafos negro BIC (caja)',4],['Archivadores A4 negro',10],
    ]],
    ['roy',  'recibido','2025-07-21 09:00:00','Reposición julio',[
        ['Carpetas A4 azul (caja 50)',6],['Grapadora de mesa',2],['Tijeras de oficina',3],
    ]],
    ['darryl','recibido','2025-09-08 08:30:00','Inicio trimestre Q4',[
        ['Papel A4 80g (500 hojas)',50],['Tóner HP color (pack 4)',2],['Rotuladores permanentes (12)',5],
    ]],
    ['roy',  'recibido','2025-10-15 09:00:00','Consumibles octubre',[
        ['Post-it 76x76 (pack 12)',8],['Celo 19mm x 33m (pack 10)',5],['Bolígrafos azul BIC (caja)',6],
    ]],
    ['darryl','recibido','2025-11-03 10:30:00','Reposición noviembre',[
        ['Papel A4 80g (500 hojas)',40],['Papel A3 80g (500 hojas)',8],['Grapas 26/6 (caja 5000)',5],
    ]],
    // ── 2026 ──
    ['darryl','recibido','2026-01-10 08:30:00','Reposición inicio de año',[
        ['Papel A4 80g (500 hojas)',40],['Tóner HP LaserJet negro',2],['Bolígrafos azul BIC (caja)',6],
    ]],
    ...
    ['roy',  'recibido','2026-02-18 09:00:00','Consumibles febrero',[
        ['Post-it 76x76 (pack 12)',8],['Celo 19mm x 33m (pack 10)',5],['Grapas 26/6 (caja 5000)',4],
    ]],
    ...
    ['roy',  'recibido','2026-04-12 08:00:00','Material oficina Q2',[
        ['Archivadores A4 negro',10],['Carpetas A4 azul (caja 50)',5],['Tijeras de oficina',4],
    ]],
    ['darryl','recibido','2026-04-18 10:00:00','Consumibles impresoras',[
        ['Tóner HP LaserJet negro',4],['Tóner HP color (pack 4)',2],
    ]],
    ['darryl','recibido','2026-05-05 10:30:00','Reposición mayo',[
        ['Papel A4 80g (500 hojas)',50],['Papel reciclado A4 (500h)',20],['Sobres blancos C4 (caja 250)',6],
    ]],
...
foreach ($todos_stock as [$usr,$est,$fech,$notas,$lineas]) {
    ...
    $ok[] = "Pedido stock #$pid — $usr ($est, ".substr($fech,0,10).")";
}
$ok[] = "Pedidos de stock añadidos (".count($todos_stock).")";

// ---- Clientes adicionales ----
$clientes_extra = [
    ['Michael Davis',    'Davis & Sons',          'mdavis@davissons.com',       '970200005','Calle Mayor 12',    'Scranton'],
    ['Sarah Connor',     'Connor Industries',     'sarah@connorind.com',        '970200006','Av. del Sol 34',    'Allentown'],
    ['Robert Mifflin',   'Mifflin & Partners',    'rmifflin@mifflinp.com',      '970200007','Calle Comercial 5', 'Wilkes-Barre'],
    ['Karen Filippelli', 'Utica Office Supply',   'karen@uticaoffice.com',      '970200008','Park Ave 100',      'Utica'],
    ['Todd Packer',      'Packer Sales LLC',      'tpacker@packersales.com',    '970200009','Industrial St 22',  'Harrisburg'],
];
...
// ---- Todos los pedidos de ventas (2025+2026, orden cronológico para IDs secuenciales) ----
$todos_ventas = [
    // ── 2025 ──
    ['jim',    'Vance Refrigeration','entregado','2025-02-10 10:00:00','Primer pedido trimestre',[
        ['Papel A4 80g (500 hojas)',20,4.20],['Sobres blancos C4 (caja 250)',3,12.50],
    ]],
    ['phyllis','Lackawanna County',  'entregado','2025-03-18 09:30:00','Reposición oficina primavera',[
        ['Archivadores A4 negro',15,3.80],['Carpetas A4 azul (caja 50)',5,18.00],
    ]],
    ['dwight', 'Prince Family Paper','entregado','2025-04-22 14:00:00','Pedido primavera',[
        ['Papel A4 80g (500 hojas)',40,4.20],['Papel reciclado A4 (500h)',10,3.60],
    ]],
    ['stanley','Karen Filippelli',   'entregado','2025-05-07 11:00:00','Material mayo',[
        ['Bolígrafos azul BIC (caja)',10,8.50],['Post-it 76x76 (pack 12)',5,12.50],
    ]],
    ['jim',    'Dunmore High School','entregado','2025-06-10 09:00:00','Fin de curso 2024-2025',[
        ['Papel A4 80g (500 hojas)',60,4.20],['Bolígrafos azul BIC (caja)',15,8.50],
    ]],
    ['andy',   'Vance Refrigeration','entregado','2025-07-01 10:00:00','Pedido verano',[
        ['Papel A4 80g (500 hojas)',25,4.20],['Sobres ventana DL (caja 500)',4,9.90],
    ]],
    ['ryan',   'Robert Mifflin',     'entregado','2025-08-19 09:00:00','Reposición agosto',[
        ['Archivadores A4 negro',20,3.80],['Celo 19mm x 33m (pack 10)',6,9.80],
    ]],
    ['dwight', 'Michael Davis',      'entregado','2025-09-09 11:00:00','Inicio de año escolar',[
        ['Papel A4 80g (500 hojas)',50,4.20],['Bolígrafos negro BIC (caja)',8,8.50],
    ]],
    ['phyllis','Lackawanna County',  'entregado','2025-10-14 10:00:00','Pedido otoño',[
        ['Carpetas A4 azul (caja 50)',8,18.00],['Archivadores A4 negro',12,3.80],
    ]],
    ['stanley','Todd Packer',        'entregado','2025-11-12 09:30:00','Material noviembre',[
        ['Grapadora de mesa',4,14.00],['Grapas 26/6 (caja 5000)',8,3.20],['Tijeras de oficina',3,4.50],
    ]],
    ['jim',    'Prince Family Paper','entregado','2025-12-03 14:00:00','Cierre de año',[
        ['Papel A4 80g (500 hojas)',30,4.20],['Papel A3 80g (500 hojas)',5,7.50],
    ]],
    // ── 2026 ──
    ['jim',    'Vance Refrigeration','entregado','2026-01-08 09:00:00','Primer pedido del año',[
        ['Papel A4 80g (500 hojas)',25,4.20],['Sobres blancos C4 (caja 250)',4,12.50],
    ]],
    ...
    ['jim',    'Lackawanna County',  'entregado','2026-02-12 10:30:00','Reposición trimestral',[
        ['Archivadores A4 negro',30,3.80],['Post-it 76x76 (pack 12)',6,12.50],['Celo 19mm x 33m (pack 10)',4,5.80],
    ]],
    ['dwight', 'Karen Filippelli',   'entregado','2026-02-26 14:00:00','',[
        ['Papel A4 80g (500 hojas)',60,4.20],['Papel reciclado A4 (500h)',15,3.60],
    ]],
    ['phyllis','Prince Family Paper','entregado','2026-03-10 11:00:00','Pedido primavera',[
        ['Bolígrafos azul BIC (caja)',12,8.50],['Bolígrafos negro BIC (caja)',8,8.50],['Carpetas A4 azul (caja 50)',10,18.00],
    ]],
    ...
    ['stanley','Michael Davis',      'entregado','2026-03-24 09:30:00','',[
        ['Grapadora de mesa',3,14.00],['Tijeras de oficina',5,4.50],['Archivadores A4 negro',20,3.80],
    ]],
    ['phyllis','Lackawanna County',  'entregado','2026-04-05 09:30:00','',[
        ['Archivadores A4 negro',20,3.80],['Carpetas A4 azul (caja 50)',5,18.00],
    ]],
    ['andy',   'Dunmore High School','entregado','2026-04-14 10:00:00','Pedido inicio trimestre',[
        ['Papel A4 80g (500 hojas)',80,4.20],['Bolígrafos azul BIC (caja)',20,8.50],
    ]],
    ...
    ['ryan',   'Robert Mifflin',     'enviado',  '2026-04-28 16:00:00','Pedido primavera',[
        ['Sobres ventana DL (caja 500)',5,9.90],['Sobres blancos C4 (caja 250)',6,12.50],
    ]],
    ['jim',    'Todd Packer',        'entregado','2026-05-06 09:00:00','',[
        ['Papel A4 80g (500 hojas)',35,4.20],['Carpetas A4 azul (caja 50)',4,18.00],['Post-it 76x76 (pack 12)',3,12.50],
    ]],
    ...
    ['dwight', 'Vance Refrigeration','enviado',  '2026-05-20 11:30:00','Segundo pedido mensual',[
        ['Tóner HP LaserJet negro',2,89.00],['Papel A4 80g (500 hojas)',20,4.20],
    ]],
    ...
    ['phyllis','Lackawanna County',  'pendiente','2026-06-04 08:30:00','Para antes del verano',[
        ['Archivadores A4 negro',25,3.80],['Carpetas A4 azul (caja 50)',8,18.00],['Grapas 26/6 (caja 5000)',5,3.20],
    ]],
];
foreach ($todos_ventas as [$usr,$cli,$est,$fech,$notas,$lineas]) {
    ...
    if (!$uid_v || !$cid_v) { $err[] = "Pedido venta sin usuario/cliente: $usr/$cli"; continue; }
    ...
    $ok[] = "Pedido venta #$pid — $usr → $cli ($est, ".substr($fech,0,10).")";
}
$ok[] = "Pedidos de ventas añadidos (".count($todos_ventas).")";
...
// ---- Logs de acceso — IPs según topología de red ----
// IT: .10-.11 | Dir: .20 | RRHH: .30-.31 | Cont: .40-.42 | Ventas: .50-.55 | Almacén: .60-.61
$logs_seed = [
    // ID 1 — mayo semana 3
    ['michael', '192.168.1.20', '2026-05-20 07:58:00'],
    ['pam',     '192.168.1.30', '2026-05-20 08:02:00'],
    ['toby',    '192.168.1.31', '2026-05-20 08:05:00'],
    ['darryl',  '192.168.1.60', '2026-05-20 07:50:00'],
    ['roy',     '192.168.1.61', '2026-05-20 07:55:00'],
    ['dwight',  '192.168.1.50', '2026-05-20 07:28:00'],
    ['jim',     '192.168.1.51', '2026-05-20 08:58:00'],
    ['stanley', '192.168.1.52', '2026-05-20 08:43:00'],
    ['angela',  '192.168.1.40', '2026-05-20 08:10:00'],
    ['oscar',   '192.168.1.41', '2026-05-20 08:15:00'],
    // ID 11 — mayo semana 3 (día 21)
    ['pam',     '192.168.1.30', '2026-05-21 08:01:00'],
    ['toby',    '192.168.1.31', '2026-05-21 08:03:00'],
    ['darryl',  '192.168.1.60', '2026-05-21 07:52:00'],
    ['jim',     '192.168.1.51', '2026-05-21 09:05:00'],
    ['dwight',  '192.168.1.50', '2026-05-21 07:30:00'],
    // ID 16 — mayo semana 4
    ['michael', '192.168.1.20', '2026-05-26 07:55:00'],
    ['pam',     '192.168.1.30', '2026-05-26 08:00:00'],
    ['darryl',  '192.168.1.60', '2026-05-26 07:48:00'],
    ['roy',     '192.168.1.61', '2026-05-26 07:58:00'],
    ['stanley', '192.168.1.52', '2026-05-26 08:40:00'],
    ['phyllis', '192.168.1.53', '2026-05-26 08:28:00'],
    // ID 22 — junio semana 1
    ['michael', '192.168.1.20', '2026-06-02 07:57:00'],
    ['pam',     '192.168.1.30', '2026-06-02 07:59:00'],
    ['toby',    '192.168.1.31', '2026-06-02 08:02:00'],
    ['darryl',  '192.168.1.60', '2026-06-02 07:50:00'],
    ['ana',     '192.168.1.10', '2026-06-02 08:58:00'],
    ['jim',     '192.168.1.51', '2026-06-02 08:53:00'],
    ['oscar',   '192.168.1.41', '2026-06-02 08:12:00'],
    // ID 29 — junio día 3
    ['pam',     '192.168.1.30', '2026-06-03 08:03:00'],
    ['toby',    '192.168.1.31', '2026-06-03 08:05:00'],
    ['ana',     '192.168.1.10', '2026-06-03 09:03:00'],
    ['alberto', '192.168.1.11', '2026-06-03 09:00:00'],
    ['jim',     '192.168.1.51', '2026-06-03 09:08:00'],
    ['dwight',  '192.168.1.50', '2026-06-03 07:23:00'],
    // ID 35 — junio día 4
    ['michael', '192.168.1.20', '2026-06-04 07:58:00'],
    ['pam',     '192.168.1.30', '2026-06-04 08:00:00'],
    ['ana',     '192.168.1.10', '2026-06-04 08:59:00'],
    ['alberto', '192.168.1.11', '2026-06-04 09:02:00'],
    ['oscar',   '192.168.1.41', '2026-06-04 08:18:00'],
    // ID 40 — junio día 5
    ['pam',     '192.168.1.30', '2026-06-05 07:56:00'],
    ['ana',     '192.168.1.10', '2026-06-05 09:01:00'],
    ['jim',     '192.168.1.51', '2026-06-05 08:55:00'],
];
...
// ---- Fichajes extra (febrero, marzo, abril y más junio) ----
$mas_fichajes2 = [
    // Febrero 2026
    ['michael', '2026-02-09 08:00:00','2026-02-09 17:30:00'],
    ['michael', '2026-02-10 08:05:00','2026-02-10 17:25:00'],
    ['angela',  '2026-02-09 08:10:00','2026-02-09 17:10:00'],
    ['angela',  '2026-02-10 08:15:00','2026-02-10 17:05:00'],
    ['oscar',   '2026-02-09 08:20:00','2026-02-09 17:20:00'],
    ['oscar',   '2026-02-10 08:18:00','2026-02-10 17:15:00'],
    ['pam',     '2026-02-09 08:00:00','2026-02-09 17:00:00'],
    ['pam',     '2026-02-10 08:05:00','2026-02-10 16:55:00'],
    // Marzo 2026
    ['jim',     '2026-03-02 09:00:00','2026-03-02 18:05:00'],
    ['jim',     '2026-03-03 09:05:00','2026-03-03 18:10:00'],
    ['jim',     '2026-03-04 09:00:00','2026-03-04 18:00:00'],
    ['pam',     '2026-03-02 08:05:00','2026-03-02 17:10:00'],
    ['pam',     '2026-03-03 08:00:00','2026-03-03 17:00:00'],
    ['angela',  '2026-03-02 08:15:00','2026-03-02 17:15:00'],
    ['oscar',   '2026-03-03 08:20:00','2026-03-03 17:20:00'],
    ['darryl',  '2026-03-02 07:50:00','2026-03-02 16:50:00'],
    ['darryl',  '2026-03-03 07:55:00','2026-03-03 16:55:00'],
    ['darryl',  '2026-03-04 07:45:00','2026-03-04 16:45:00'],
    ['dwight',  '2026-03-02 07:30:00','2026-03-02 16:30:00'],
    ['dwight',  '2026-03-03 07:25:00','2026-03-03 16:25:00'],
    // Abril 2026
    ['angela',  '2026-04-07 08:15:00','2026-04-07 17:15:00'],
    ['angela',  '2026-04-08 08:10:00','2026-04-08 17:10:00'],
    ['oscar',   '2026-04-07 08:20:00','2026-04-07 17:20:00'],
    ['oscar',   '2026-04-08 08:25:00','2026-04-08 17:25:00'],
    ['kevin',   '2026-04-07 08:30:00','2026-04-07 17:30:00'],
    ['kevin',   '2026-04-08 08:35:00','2026-04-08 17:35:00'],
    ['andy',    '2026-04-07 09:00:00','2026-04-07 18:00:00'],
    ['andy',    '2026-04-08 09:05:00','2026-04-08 18:05:00'],
    ['ryan',    '2026-04-07 09:10:00','2026-04-07 18:10:00'],
    ['dwight',  '2026-04-07 07:30:00','2026-04-07 16:30:00'],
    ['dwight',  '2026-04-08 07:35:00','2026-04-08 16:35:00'],
    // Junio adicional
    ['dwight',  '2026-06-04 07:25:00','2026-06-04 16:25:00'],
    ['dwight',  '2026-06-05 07:30:00','2026-06-05 16:30:00'],
    ['angela',  '2026-06-04 08:15:00','2026-06-04 17:15:00'],
    ['angela',  '2026-06-05 08:10:00','2026-06-05 17:10:00'],
    ['kevin',   '2026-06-04 08:30:00','2026-06-04 17:30:00'],
    ['darryl',  '2026-06-04 07:55:00','2026-06-04 16:55:00'],
    ['roy',     '2026-06-04 08:00:00','2026-06-04 17:00:00'],
    ['toby',    '2026-06-05 08:05:00','2026-06-05 17:05:00'],
];
foreach ($mas_fichajes2 as [$usr,$entrada,$salida]) {
    $uid_mf2 = $conn->query("SELECT id FROM usuarios WHERE usuario='$usr' LIMIT 1")->fetch_row()[0] ?? null;
    if (!$uid_mf2) continue;
    $i1 = $conn->prepare("INSERT INTO fichajes (usuario_id,tipo,fecha) VALUES (?,'entrada',?)");
    $i1->bind_param('is',$uid_mf2,$entrada); $i1->execute();
    $i2 = $conn->prepare("INSERT INTO fichajes (usuario_id,tipo,fecha) VALUES (?,'salida',?)");
    $i2->bind_param('is',$uid_mf2,$salida); $i2->execute();
}
$ok[] = "Fichajes extra (feb/mar/abr/jun) añadidos";

// ---- Vacaciones de ejemplo ----
$vacaciones_seed = [
    // Pam: mi 1 jul → mi 15 jul, 11 días laborables
    ['pam',    '2026-07-01','2026-07-15',11,'Vacaciones verano',       'aprobada', 'Aprobado por RRHH'],
    // Jim: lun 3 ago → vie 7 ago, 5 días laborables (agosto 1 era sábado)
    ['jim',    '2026-08-03','2026-08-07', 5,'Viaje familiar',          'aprobada', 'Aprobado'],
    // Dwight: mar 14 jul → vie 17 jul, 4 días laborables (julio 18 era sábado)
    ['dwight', '2026-07-14','2026-07-17', 4,'Granja de remolacha',     'pendiente',''],
    // Stanley: mar 1 sep → vie 4 sep, 4 días laborables (septiembre 5 era sábado)
    ['stanley','2026-09-01','2026-09-04', 4,'Asunto personal',         'pendiente',''],
    // Kevin: lun 22 jun → jue 25 jun, 4 días laborables (junio 20 era sábado)
    ['kevin',  '2026-06-22','2026-06-25', 4,'Semana de descanso',      'rechazada','No hay cobertura en esa semana'],
];
...
$tickets_seed = [
    ...
    ['Oscar Martinez','oscar.martinez@dundermifflin.com','Error en total de factura',            'La factura del pedido #42 muestra un total que no coincide con las líneas.', 'resuelto',   'ana'],
    ['Ryan Howard',   'ryan.howard@dundermifflin.com',   'Contraseña olvidada',                 'Llevo dos días sin poder entrar, ¿podéis resetear mi contraseña?', 'resuelto',   'ana'],
    ['Phyllis Vance', 'phyllis.vance@dundermifflin.com', 'Pedido no aparece en el sistema',     'El pedido de Vance Refrigeration del mes pasado no aparece en mi lista.', 'en_proceso', 'alberto'],
    ['Michael Scott', 'michael.scott@dundermifflin.com', 'Acceso a informes de dirección',      '¿Puedo tener un panel con las ventas totales de la sucursal? Es importante.', 'abierto',     null],
    ['Kevin Malone',  'kevin.malone@dundermifflin.com',  'Contabilidad no carga',               'Desde el viernes la página de contabilidad da error y no muestra nada.', 'resuelto',   'ana'],
    ['Darryl Philbin','darryl.philbin@dundermifflin.com','Stock no se actualizó tras pedido',   'Recibimos el pedido pero el inventario sigue igual. Alguien lo tiene que revisar.', 'en_proceso', 'alberto'],
    ['Angela Martin', 'angela.martin@dundermifflin.com', 'Exportar datos de contabilidad',      '¿Se puede descargar un Excel con los movimientos del mes? Lo necesito para auditoría.', 'abierto',     null],
    ['Jim Halpert',   'jim.halpert@dundermifflin.com',   'Pedido marcado como pendiente',       'El pedido de Dunmore High School lleva semanas y sigue "pendiente". ¿Está enviado ya?', 'resuelto',   'ana'],
];
...
// usuarios de mysql por rol — uno por rol de aplicación
$tablas_todas = ['usuarios','empleados','inventario','pedidos','pedidos_lineas','logs_acceso','logs_actividad','clientes','pedidos_ventas','pedidos_ventas_lineas','fichajes','justificantes','tickets','vacaciones'];
$usuarios_mysql = [
    // login: solo para pantalla de acceso y tickets anónimos
    'login_gestint'        => ['Login2024!',       false, ['INSERT ON gestint.logs_acceso','INSERT ON gestint.tickets']],
    // sistema e it: acceso total
    'sistema_gestint'      => ['Sistema2026*',     true,  []],
    'it_gestint'           => ['IT2024!',          true,  []],
    // direccion: solo lectura + gestión propia de vacaciones/fichajes/tickets
    'direccion_gestint'    => ['Direccion2024!',   false, ['INSERT ON gestint.fichajes','INSERT ON gestint.vacaciones','INSERT ON gestint.tickets','INSERT ON gestint.logs_actividad']],
    // rrhh: gestión de empleados, usuarios, fichajes, justificantes, vacaciones
    'rrhh_gestint'         => ['RRHH2024!',        false, ['INSERT, UPDATE, DELETE ON gestint.empleados','INSERT, UPDATE, DELETE ON gestint.usuarios','INSERT, UPDATE ON gestint.fichajes','INSERT ON gestint.justificantes','INSERT ON gestint.tickets','INSERT, UPDATE, DELETE ON gestint.vacaciones','INSERT ON gestint.logs_actividad']],
    // almacen: inventario, pedidos stock, ver/actualizar estado pedidos ventas
    'almacen_gestint'      => ['Almacen2024!',     false, ['INSERT, UPDATE, DELETE ON gestint.inventario','INSERT, UPDATE, DELETE ON gestint.pedidos','INSERT, UPDATE, DELETE ON gestint.pedidos_lineas','INSERT ON gestint.fichajes','UPDATE ON gestint.pedidos_ventas','INSERT ON gestint.vacaciones','INSERT ON gestint.logs_actividad']],
    // ventas: gestión pedidos y clientes
    'ventas_gestint'       => ['Ventas2024!',      false, ['UPDATE (password) ON gestint.usuarios','INSERT, UPDATE ON gestint.pedidos_ventas','INSERT, UPDATE ON gestint.pedidos_ventas_lineas','INSERT, UPDATE, DELETE ON gestint.clientes','UPDATE ON gestint.inventario','INSERT ON gestint.fichajes','INSERT ON gestint.justificantes','INSERT ON gestint.tickets','INSERT ON gestint.vacaciones','INSERT ON gestint.logs_actividad']],
    // contabilidad: solo lectura + gestión propia
    'contabilidad_gestint' => ['Contab2024!',      false, ['INSERT ON gestint.fichajes','INSERT ON gestint.vacaciones','INSERT ON gestint.tickets','INSERT ON gestint.logs_actividad']],
    // recepcion: solo lectura + gestión propia
    'recepcion_gestint'    => ['Recepcion2024!',   false, ['INSERT ON gestint.fichajes','INSERT ON gestint.vacaciones','INSERT ON gestint.tickets','INSERT ON gestint.logs_actividad']],
];

foreach ($usuarios_mysql as $usr => [$pass, $todo, $escritura]) {
    $conn->query("DROP USER IF EXISTS '$usr'@'localhost'");
    $conn->query("CREATE USER '$usr'@'localhost' IDENTIFIED BY '$pass'");
    if ($conn->error) { $err[] = "MySQL $usr: ".$conn->error; continue; }
    if ($todo) {
        $conn->query("GRANT ALL PRIVILEGES ON gestint.* TO '$usr'@'localhost'");
    } else {
