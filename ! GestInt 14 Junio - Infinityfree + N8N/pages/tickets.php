...
if (!puedeSistema()) { header('Location: dashboard.php'); exit; }
...
if ($tab === 'mios') {
    ...
    $where = "WHERE t.estado = 'en_proceso'";
} elseif ($tab === 'resueltos') {
    $where = "WHERE t.estado = 'resuelto'";
} elseif ($tab === 'todos') {
    $where = "WHERE 1=1";
} else {
    // abiertos: solo los sin asignar todavía
    $where = "WHERE t.estado = 'abierto'";
}
        ...
        <div class="panel" style="margin-bottom:16px;">
            <div class="panel-body" style="padding:10px 16px;">
                <div class="barra-filtros">
                    <a href="?tab=abiertos"   class="btn <?= $tab==='abiertos'   ?'btn-primario':'btn-gris' ?> btn-sm">Abiertos</a>
                    <a href="?tab=en_proceso" class="btn <?= $tab==='en_proceso' ?'btn-primario':'btn-gris' ?> btn-sm">En proceso</a>
