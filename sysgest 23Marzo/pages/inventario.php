...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errores)) {
        ...
        if ($edit_id > 0) {
            // nombre(s) categoria(s) descripcion(s) cantidad(i) stock_minimo(i) unidad(s) proveedor(s) precio(d) id(i)
            $stmt = $conn->prepare(
        ...
        <main class="main">
            ...
            <div class="panel" style="margin-bottom:16px;">
                <div class="panel-body" style="padding:12px 16px;">
                    <form method="GET" class="barra-filtros">
                        <input type="text" name="buscar" placeholder="Artículo, proveedor..."
            ...
            <div class="panel">
                <table>
                    <thead>
                        <tr>
                            <th>Artículo</th><th>Categoría</th><th>Cantidad</th><th>Mínimo</th>
                            <th>Unidad</th><th>Precio unit.</th><th>Proveedor</th><th>Estado</th><th>Acciones</th>
                        </tr>
                    </thead>
                    <tbody>
                            ...
                            <td>
                                <div class="d-flex gap-8">
                                    ...
                                    <a href="?accion=eliminar&id=<?= $a['id'] ?>"
                                       ...
                                       onclick="return confirm('¿Eliminar este artículo?')">🗑</a>
                                </div>
                            </td>
                        </tr>
                        <?php endwhile; ?>
                ...
                <div class="form-grid">
                    ...
                    <div class="form-grupo">
                        ...
                        <input type="number" name="cantidad" min="0"
                               value="<?= $art_editar['cantidad'] ?? 0 ?>">
                    </div>
                    <div class="form-grupo">
                        <label>Stock mínimo</label>
                        <input type="number" name="stock_minimo" min="0"
                               value="<?= $art_editar['stock_minimo'] ?? 5 ?>">
                    </div>
                    <div class="form-grupo">
                        <label>Unidad</label>
                        <select name="unidad">
                    ...
                    <div class="form-grupo">
                        ...
                        <input type="number" name="precio_unitario" min="0" step="0.01"
                               value="<?= $art_editar['precio_unitario'] ?? 0 ?>">
                    </div>
                    <div class="form-grupo full">
