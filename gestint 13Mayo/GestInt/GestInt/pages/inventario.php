...
// Unidades en camino por artículo (suma de pedidos no recibidos)
$ec_q = $conn->query(
    "SELECT pl.inventario_id, SUM(pl.cantidad) AS total
     FROM pedidos_lineas pl
     JOIN pedidos p ON p.id = pl.pedido_id
     WHERE p.estado != 'recibido'
     GROUP BY pl.inventario_id"
);
$en_camino = [];
                ...
                <table>
                    ...
                    <?php if ($articulos->num_rows > 0): ?>
                        ...
                        <tr>
                            ...
                            <td>
                                <?php if ($camino > 0): ?>
                                    <span class="badge badge-azul">+<?= $camino ?></span>
                                <?php else: ?>
                            ...
                            <td>
                                ...
                                <?php endif; ?>
                                <?php if ($camino > 0): ?>
                                    <span class="badge badge-azul" style="display:block;margin-top:4px;">Pedido realizado</span>
                                <?php endif; ?>
                            </td>
                            <td>
